...
- **Command:** `"$HOME/.claude/skills/seo-skill/bin/seo-skill" run moz_api.py`
...
- **Command:** `"$HOME/.claude/skills/seo-skill/bin/seo-skill" run bing_webmaster.py`
...
- **Command:** `"$HOME/.claude/skills/seo-skill/bin/seo-skill" run commoncrawl_graph.py`
...
- **Command:** `"$HOME/.claude/skills/seo-skill/bin/seo-skill" run verify_backlinks.py`
