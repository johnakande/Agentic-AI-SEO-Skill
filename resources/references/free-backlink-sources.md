...
- **Command:** `python3 <SKILL_DIR>/scripts/moz_api.py`
...
- **Command:** `python3 <SKILL_DIR>/scripts/bing_webmaster.py`
...
- **Command:** `python3 <SKILL_DIR>/scripts/commoncrawl_graph.py`
...
- **Command:** `python3 <SKILL_DIR>/scripts/verify_backlinks.py`
